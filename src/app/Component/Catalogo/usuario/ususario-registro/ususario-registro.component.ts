...
export class UsusarioRegistroComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reactiveForm = new FormGroup({
      ...
      'nSarario': new FormControl('', [Validators.required, Validators.email]),
      'tPuesto': new FormControl('', [Validators.required, Validators.email]),
  ...
  getEditarRegistro(){
    this._service.getDetalle(this.ecodUsuarios).then((response:any)=>{
      ...
      this.datos.nSarario= datosUsuarios.nSarario;
      this.datos.tPuesto= datosUsuarios.tPuesto;
